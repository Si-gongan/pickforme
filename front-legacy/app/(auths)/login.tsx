...
const LoginScreen: React.FC<Props> = (props) => {
  ...
  const [isOnboardingFinished, setIsOnboardingFinished] = useAtom(
    isOnboardingFinishedAtom
  );
  ...
  const [loginGoogleReady, loginGoogleResult, loginGoogleBase] =
  ...
  React.useEffect(() => {
    if (
      loginGoogleResult?.type === "success" &&
      loginGoogleResult.authentication
    ) {
      const {
    ...
    <View style={[styles.container, props.style]}>
      ...
      <View style={styles.buttonWrap}>
        ...
        >
          <Image
            style={styles.icon}
            source={require("../../assets/images/auth/kakao.png")}
          />
        </Button>
