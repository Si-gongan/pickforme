...
const HansiryunPopup: React.FC<HansiryunPopupProps> = ({ visible, onClose }) => {
                ...
                <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                    <ScrollView style={styles.scrollView}>
                        <Text style={[styles.description, { color: theme.text.primary }]}>
                            ...
                            하셨다면 신청이 완료됩니다.{'\n'}
                            {'\n'}
                            한번 신청하시면, 신청일 기준 다음 달 1일부터 6개월 간 멤버십 서비스를 이용하실 수 있어요.
                            더욱 자세한 내용이 궁금하시다면 넓은마을 픽포미 공지사항을 참고해 주세요!{'\n'}
                            {'\n'}
                            항상 픽포미 서비스를 애용해 주셔서 감사드립니다.{'\n'}
                        </Text>

                        <View style={styles.phoneInputContainer}>
                            <Text style={[styles.inputLabel, { color: theme.text.primary }]}>전화번호</Text>
                            <TextInput
                                style={[
                                    styles.input,
