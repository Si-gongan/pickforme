...
import { StyleSheet, TextStyle, ViewStyle, Pressable, TouchableOpacity } from 'react-native';
        ...
        >
            <View style={[dynamicStyles.bottomSheet, { backgroundColor: theme.background.primary }]}>
                ...
                >
                    ...
                    {'\n'}
                    픽포미 체험단은 앱을 직접 사용해 쇼핑을 경험하고, 체험 후기를 작성하고 공유하는 활동으로 진행됩니다.
                    모집 대상은 온라인 쇼핑에 불편을 겪어본 시각장애인 당사자, 픽포미를 처음 접하거나 정보 접근성 기술에
                    관심 있는 분, 그리고 실제 사용 경험을 바탕으로 솔직한 의견으로 서비스 개선에 함께 하고 싶은
                    분들입니다. 체험단 참여자에게는 최대 1만 원 상품 구매 페이백과 픽포미 멤버십 3개월 사용권이
                    제공되며, 우수 후기자에게는 기프티콘 1만 원이 추가로 증정됩니다.{'\n'}※ 활동과 관련한 자세한 내용은
                    체험단에 선정된 분들을 대상으로 개별 안내될 예정입니다.
                </Text>
                ...
                >
                    ...
                    하단의 '문의하기' 버튼을 이용해주세요. 신청하신 분들께 선정 결과 및 활동 안내를 개별 연락 드립니다.
                </Text>
                ...
                <Text
                    ...
                    accessibilityRole="text"
                >
                    픽포미는 아직 성장 중인 서비스입니다. 여러분의 사용 경험과 피드백이, 더 많은 사람들의 정보 접근성을
                    바꾸는 중요한 시작점이 됩니다. 많은 관심과 참여 부탁드립니다.
                </Text>
