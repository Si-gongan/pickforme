    ...
    >
      <View style={baseStyles.bottomSheet}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.desc}>
          궁금한 점이 생기면 상품 상세페이지의 질문하기 탭을 눌러서 픽포미 AI에게 자유롭게 질문하세요! 픽포미 AI가 빠르고 자세하게 설명해줄 거에요!
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.subtitle}>
          ...
          <Text style={styles.desc}>
          궁금한 점이 생기면 매니저 질문하기 버튼을 눌러 상품에 대해 궁금한 점을 물어보세요. 픽포미 매니저가 한시간에서 두시간 이내로 답변해 줄거예요. 답변은 위시리스트 탭에서 매니저에게 문의한 상품에서 확인할 수 있어요.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.desc}>
