...
export const searchProductsAtom = atom(
  ...
  async (get, set, { onQuery, onLink, ...params }: SearchProductsRequest) => {
    ...
    try {
      ...
      const {
        data: { platform, url },
      } = await ParseProductUrlAPI({ url: params.query });
...
export const getProductReviewAtom = atom(
  null,
  async (get, set, product: Product) => {
    set(loadingStatusAtom, {
      ...get(loadingStatusAtom),
...
export const getProductReportAtom = atom(
  null,
  async (get, set, product: Product) => {
    set(loadingStatusAtom, {
      ...get(loadingStatusAtom),
...
export const getProductCaptionAtom = atom(
  null,
  async (get, set, product: Product) => {
    set(loadingStatusAtom, {
      ...get(loadingStatusAtom),
...
export const getProductAIAnswerAtom = atom(
  null,
  async (get, set, product: Product, question: string) => {
    set(loadingStatusAtom, {
      ...get(loadingStatusAtom),
...
export const setClipboardProductAtom = atom(
  null,
...
export const setScrapedProductDetailAtom = atom(
  null,
  async (get, set, { images, reviews }: ScrapedProductDetail) => {
