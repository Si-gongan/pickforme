...
export const GetProductsAPI = (params: GetProductsParams) =>
  client.get<Product[]>(`/product/${params.platform}`);
...
export const GetSubscriptionListAPI = () =>
  client.get<Purchase[]>(`/purchase/subscriptions`);
export const GetPurchaseListAPI = () =>
  client.get<Purchase[]>(`/purchase/purchases`);

export const GetPurchaseCheckAPI = () =>
  client.get<Purchase[]>(`/purchase/check`);
export const GetPurchaseSubCheckAPI = () =>
  client.get<PurchaseSubCheck>(`/purchase/subCheck`);
