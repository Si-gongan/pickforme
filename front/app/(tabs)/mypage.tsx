        ...
        <View style={styles.scrollContainer}>
          {!!userData && (
            <View style={styles.card}>
              <Text style={styles.title}>잔여 이용권</Text>
              <Text style={styles.menu}>
                매니저 질문권 {userData?.point ?? "00"}회
              </Text>
              {(userData?.aiPoint || 0) >= 1000 ? (
                <Text style={styles.menu}>AI 질문권 무제한</Text>
              ) : (
                <Text style={styles.menu}>
          ...
          <View style={styles.card}>
            ...
            <Link href="/(settings)/nickname" accessibilityRole="button">
              <Text style={styles.menu}>내 정보 수정하기</Text>
            </Link>
            ...
            {userData ? (
              ...
              <>
                <Link href="/subscription" accessibilityRole="button">
                  <Text style={styles.menu}>멤버십 이용하기</Text>
                </Link>
                <Link href="/subscription-history" accessibilityRole="button">
                  <Text style={styles.menu}>멤버십 구매내역</Text>
                </Link>
              </>
            )}
          </View>
          <View style={styles.card}>
            ...
            <Link href="/(settings)/theme" accessibilityRole="button">
              <Text style={styles.menu}>화면 모드 변경하기</Text>
            </Link>
            {!!userData && (
              <Link href="/(settings)/notification" accessibilityRole="button">
                <Text style={styles.menu}>알림 설정하기</Text>
              </Link>
            )}
          </View>
          <View style={styles.card}>
            ...
            <Link href="/how" accessibilityRole="button">
              <Text style={styles.menu}>사용 설명서</Text>
            </Link>
            <Link href="/faq" accessibilityRole="button">
              <Text style={styles.menu}>자주 묻는 질문</Text>
            </Link>
            <Button
              title="개인정보처리방침"
              variant="text"
