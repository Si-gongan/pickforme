...
const FAQS: {
  ...
  AI: {
    ...
    questions: [{
      ...
      answer: 'AI 포미는 최선의 정보를 제공하기 위해 노력하고 있어요. 그럼에도 아직 포미는 똑똑해지는 중이어서, 완벽한 정보를 제공하지 못할 수도 있습니다. 포미를 통해 충분한 정보를 얻지 못하셨다면, 매니저가 직접 제공하는 상품 추천받기 혹은 상품 설명받기 서비스를 이용해보시는 걸 추천드려요.',
    }],
  },
  PICKFORME: {
    name: `픽포미\n서비스`,
    questions: [{
      ...
      answer: '상품 추천받기와 상품 설명받기는 매니저가 고객님의 요청에 따라 하나하나 꼼꼼하게 맞춤형 정보를 작성해서 제공하는 서비스입니다. 의뢰를 확인하고, 답변을 제공하는 과정에서 최대 1~2시간이 소요됩니다. 매니저가 정성스럽게 답변을 작성하는 중이니 조금만 더 기다려 주세요. 더 빠른 서비스를 제공하기 위해 노력하겠습니다.',
    }, {
  ...
  POINT: {
    ...
    questions: [{
      ...
      answer: '마이페이지의 ‘픽 충전’ 페이지에서 원하는 단위를 선택해 픽을 충전하실 수 있어요. 현재 픽포미는 다양한 서비스를 무료로 이용해보실 수 있게 회원가입 시 1픽을 제공해드리고 있습니다. 1픽으로 매니저가 제공하는 상품 추천받기, 상품 설명받기(유료 서비스)를 무료로 이용해 보세요!',
    }],
  },
}
