...
5. 마이페이지 탭: 내 정보 수정, 픽 충전, 앱 설정 변경, 고객 지원 기능이 있습니다. ‘내 정보’에서는 닉네임과 시각장애 정보를 수정할 수 있고, ‘픽 충전하기’에서는 유료 서비스 이용을 위한 픽을 구매할 수 있습니다. ‘앱 설정’에서는 화면 모드, 알림 기능을 설정할 수 있습니다. ‘고객 지원’에서는 카카오톡 채널을 통해 1:1 문의가 가능합니다. 또한 앱 사용 설명서, 자주 묻는 질문을 확인할 수 있습니다.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.desc}>
