    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          마이페이지 탭에는 내 정보 수정, 포인트 충전, 앱 설정 변경, 고객 지원 기능이 있습니다. ‘내 정보 수정’에서는 닉네임과 로그인 정보를 수정할 수 있고, ‘포인트 충전’에서는 유료 서비스 이용을 위한 포인트를 구매할 수 있습니다. ‘앱 설정’에서는 텍스트 크기와 화면 모드, 알림 기능을 설정할 수 있습니다.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.desc}>
